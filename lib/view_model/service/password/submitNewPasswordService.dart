...
class SubmitNewPasswordService {

  static Future _requestNewPassword() async {
    ...
    Map<String, dynamic> requestBody = {
      ...
      "email"       : "user1@cotafer.com", 
      "code"        : "123456"
      };
    var url = Uri.parse('http://192.168.10.14:7071/forgot/password/submit');
    var changePasswordRespone = AccessRespone();
    ...
    try {
      ...
      if (respone.statusCode == 200) {
        ...
        changePasswordRespone = accessResponeFromJson(respone.body);
        return changePasswordRespone.errorMessage;
      }
    } catch (e) {
  ...
  static submitNewPassword() async {
    var data = await _requestNewPassword();
    if (data != '' && data != null) {
      return data;
    } else
      return null;
